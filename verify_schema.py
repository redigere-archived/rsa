...
def verify_schema(password):
    ...
    expected_tables = {
        ...
        "CONTRATTO": {"CODICE_CONTRATTO": "NUMBER", "PAGA_ORARIA": "NUMBER", "TIPO_CONTRATTO": "VARCHAR2", "TASSA_DETRATTA": "NUMBER"},
        ...
        "AZIENDA_ESTERNA": {"PARTITA_IVA": "VARCHAR2", "NUMERO_DI_TELEFONO": "VARCHAR2", "CODICE_FISCALE_OPERATORE": "VARCHAR2"},
        "DITTA_PULIZIE": {"PARTITA_IVA": "VARCHAR2"},
        "DITTA_RISTORANTE": {"PARTITA_IVA": "VARCHAR2"},
        "FORNISCE": {"PARTITA_IVA": "VARCHAR2", "NUMERO_CAMERA": "NUMBER", "NOME": "VARCHAR2"},
        ...
        "PRENOTAZIONE": {"CODICE_PRENOTAZIONE": "NUMBER"},
        "TURNO_PROGRAMMATO": {"ORA_INIZIO": "VARCHAR2", "ORA_FINE": "VARCHAR2", "GIORNO": "DATE", "FASCIA_ORARIA": "VARCHAR2"},
        "TURNO_EFFETTUATO": {"ORA_INIZIO": "VARCHAR2", "ORA_FINE": "VARCHAR2", "GIORNO": "DATE", "FASCIA_ORARIA": "VARCHAR2"},
        "VISITA": {"CODICE_FISCALE_PARENTE": "VARCHAR2", "GIORNO_VISITA": "DATE", "ORA_INGRESSO": "VARCHAR2", "CODICE_FISCALE_RESIDENTE": "VARCHAR2"},
